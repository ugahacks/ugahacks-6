...
function Footer(props) {
  return (
        <footer className='section fp-auto-height'>
            ...
            <a href="https://www.ugahacks.com/" target="_blank" rel="noopener noreferrer" className="footericons"><img id="byte" src={orgsite} alt="Ugahacks Organization Website"></img></a>
