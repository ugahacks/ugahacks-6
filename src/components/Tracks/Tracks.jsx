      ...
      <section className="section tracks-section" id="tracks">
        <div className="tracks-container">
          <div className="tracks-text-container">
            ...
            Our Track this year is <b>Hardware!</b> Builder Byte is excited to see what you will build using different forms of hardware technology such as arduino kits, raspberry pis, etc! </p>
